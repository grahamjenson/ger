...
(function() {
  ...
  EventStoreMapper = (function() {
    ...
    EventStoreMapper.prototype.bootstrap = function(stream) {
      return this.knex.client.acquireConnection().then((function(_this) {
        return function(connection) {
          var counter, deferred, pg_stream;
          deferred = bb.defer();
          pg_stream = connection.query(copyFrom("COPY " + _this.schema + ".events (person, action, thing, created_at, expires_at) FROM STDIN CSV"));
          ...
          return deferred.promise["finally"](function() {
            return _this.knex.client.releaseConnection(connection);
          });
        };
      })(this));
    };
