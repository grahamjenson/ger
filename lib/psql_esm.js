  ...
  EventStoreMapper = (function() {
    ...
    EventStoreMapper.prototype.init_tables = function() {
      return this.knex.schema.raw("CREATE SCHEMA IF NOT EXISTS " + this.schema).then((function(_this) {
        return function() {
          return q.all([_this.init_events_table(), _this.init_action_table()]);
        };
      })(this));
    };

    EventStoreMapper.prototype.init_events_table = function() {
      return this.knex.schema.createTable("" + this.schema + ".events", function(table) {
        table.increments();
    ...
    EventStoreMapper.prototype.init_action_table = function() {
      return this.knex.schema.createTable("" + this.schema + ".actions", function(table) {
        table.increments();
