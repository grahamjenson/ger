...
(function() {
  ...
  EventStoreMapper = (function() {
    ...
    EventStoreMapper.prototype.drop_tables = function() {
      return q.all([this.knex.schema.dropTableIfExists("" + this.schema + ".events"), this.knex.schema.dropTableIfExists("" + this.schema + ".actions")]);
    };
    ...
    EventStoreMapper.prototype.init_events_table = function() {
      return this.knex.schema.raw("CREATE SCHEMA IF NOT EXISTS " + this.schema).then((function(_this) {
        return function() {
          return _this.knex.schema.hasTable("" + _this.schema + ".events");
        };
        ...
        return function(has_events_table) {
          if (has_events_table) {
            ...
            return _this.knex.schema.createTable("" + _this.schema + ".events", function(table) {
              table.increments();
    ...
    EventStoreMapper.prototype.init_action_table = function() {
      return this.knex.schema.hasTable("" + this.schema + ".actions").then((function(_this) {
        return function(has_actions_table) {
          if (has_actions_table) {
            return true;
          } else {
            return _this.knex.schema.createTable("" + _this.schema + ".actions", function(table) {
              table.increments();
