...
(function() {
  var EventStoreMapper, drop_tables, init_action_table, init_events_table, init_tables, q,
  ...
  drop_tables = function(knex, schema) {
    ...
    return q.all([knex.schema.dropTableIfExists("" + schema + ".events"), knex.schema.dropTableIfExists("" + schema + ".actions")]);
  };
